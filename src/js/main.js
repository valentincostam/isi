let materiasISI = JSON.parse(localStorage.getItem('materias')) || [
  ...
  // - Primer cuatrimestre
  { id: '18', nombre: 'Física II',                       horas: '10', ano: '3', cuatrimestre: '1', esAnual: false, estado: 'desaprobada', analista: false, integradora: false, electiva: false, paraCursar: { necesitaRegular: ['1', '10'],        necesitaAprobada: []} },
